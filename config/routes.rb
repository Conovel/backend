...
Rails.application.routes.draw do
  ...
  namespace :v1 do
    ...
    # add_openapi_route 'GET', '/users/{user_id}/posted_novels', controller_name: 'users', action_name: 'get_novels_by_user_id'
    # add_openapi_route 'GET', '/users/{user_id}', controller_name: 'users', action_name: 'show'
    add_openapi_route 'GET', '/users/me', controller_name: 'users', action_name: 'get_user_by_me'
    # add_openapi_route 'GET', '/users/me/viewed_novels', controller_name: 'users', action_name: 'get_viewed_novels_by_me'
