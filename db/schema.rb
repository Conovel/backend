...
ActiveRecord::Schema[7.0].define(version: 2024_11_04_222720) do
  create_table "evaluations", primary_key: ["sentence_id", "evaluator_user_id"], charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["sentence_id", "evaluator_user_id"], name: "index_evaluations_on_sentence_id_and_evaluator_user_id", unique: true
  end

  create_table "genres", primary_key: "genre_id", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "sentences", primary_key: "sentence_id", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "title_genres", primary_key: ["title_id", "genre_id"], charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "title_id", null: false
  ...
  create_table "titles", primary_key: "title_id", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "viewed_sentences", primary_key: ["viewed_sentence_id", "viewed_user_id"], charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["viewed_sentence_id", "viewed_user_id"], name: "index_viewed_sentences_on_viewed_sentence_id_and_viewed_user_id", unique: true
